package com.hik.netsdk.SimpleDemo.Control;
...
public class DevManageGuider implements Serializable {
    ...
    private int m_iCurrLoginID = -1; // 当前登录 ID

    /**
     * @fn getCurrentLoginID
     * @return m_iCurrLoginID int
     * @brief 获取当前设备的登录 ID
     */
    public int getCurrentLoginID() {
        return m_iCurrLoginID;
    }

    /**
     * @fn setCurrentLoginID
     * @param lUserID int
     * @brief 设置当前设备登录 ID
     */
    public void setCurrentLoginID(int lUserID) {
        m_iCurrLoginID = lUserID;
    }
