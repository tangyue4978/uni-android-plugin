...
function list(data_info) {
	...
	var _url = root + 'api/v3/hydropower_station/statistics';
	console.log(_url);
	mui.ajax(_url, {
		data: data_info,
		...
		success: function(data) {
			...
			if(data.code == 1) {
				...
				<!-- 数据来源end -->
				$(".river_lake_title_l #text1").html(data.data.titl);
				...
				$("#tabcontent").html("");
				$("#tabhead").html("");
				$("#tabcontent").append(data.data.header);
				...
				$("#tabhead").append(data.data.leftHeader)
