    ...
    if (item.datatype == "point") {
        ...
        waterQualitylayers[item.name] = new ol.layer.Vector({
            source: new ol.source.Vector({
				...
				// url: function (extent) {
				// 	console.log(extent)
				// 	return (item.serverInfo.WFS.url + '?service=WFS&' +
				// 		'version=1.0.0&request=GetFeature&typeName=七河&' +
...
var layersInfo = [
	...
	// 七河五湖
	{
	    ...
	    serverInfo: {
	        ...
	        WFS: {
	            url: "../../js/map/json/shanxi_qihe.json",
	            // url: 'http://gis.sxjicheng.cn:8081/freexserver/wfs',
				type: "WFS",
	            layer: "七河",
	        },
	    }
