...
function list(data_info) {
	...
	var _url = root + 'api/v3/reservoir/summary';
	console.log(_url);
	mui.ajax(_url, {
		data: data_info,
		...
		success: function(data) {
			...
			if(data.code == 1) {
				...
				//$(".tab_li li").bind("click",{column: data.data.cityColumn, cityColumn: data.data.cityColumn}, liActive);
