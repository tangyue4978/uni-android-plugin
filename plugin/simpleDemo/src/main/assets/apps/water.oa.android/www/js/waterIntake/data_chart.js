...
function pieChartFirst(id,obj){
	var chart = Highcharts.chart(id, {
		...
		plotOptions: {
			...
			　　　　　　　return '<span style="color:#91ee93">' + this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '采矿业'){
			　　　　　　　　　return '<span style="color:#fd0100">'+ this.y + obj.unit ;
			　　　　　　　}else if(this.point.name == '制造业'){
			　　　　　　　　　return '<span style="color:#ff8252">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '电力、燃气及水的生产和供应业'){
			　　　　　　　　　return '<span style="color:#aeff34">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '建筑业'){
			　　　　　　　　　return '<span style="color:#028100">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '批发和零售业'){
			　　　　　　　　　return '<span style="color:#f3fdf4">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == 'G.交通运输、仓储和邮政业'){
			　　　　　　　　　return '<span style="color:#41e0ce">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '住宿和餐饮业'){
			　　　　　　　　　return '<span style="color:#30504f">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '信息传输、计算机服务和软件业'){
			　　　　　　　　　return '<span style="color:#03fcfe">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '金融业'){
			　　　　　　　　　return '<span style="color:#02befb">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '房地产业'){
			　　　　　　　　　return '<span style="color:#1d92fb">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '租赁和商务服务业'){
			　　　　　　　　　return '<span style="color:#4669df">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '科学研究和技术服务业'){
			　　　　　　　　　return '<span style="color:#e8e5f8">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '水利、环境和公共设施管理业'){
			　　　　　　　　　return '<span style="color:#9901d2">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '居民服务和其他服务业'){
			　　　　　　　　　return '<span style="color:#d8bcd3">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '教育'){
			　　　　　　　　　return '<span style="color:#dd143e">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '卫生、社会保障和社会福利业'){
			　　　　　　　　　return '<span style="color:#191a76">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '文化、体育和娱乐业'){
			　　　　　　　　　return '<span style="color:#f1f8ff">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '公共管理和社会组织'){
			　　　　　　　　　return '<span style="color:#b0edee">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '国际组织'){
			　　　　　　　　　return '<span style="color:#03898a">'+ this.y + obj.unit;
			　　　　　　　}else if(this.point.name == '其他'){
			　　　　　　　　　return '<span style="color:#00fe81">'+ this.y + obj.unit;
			　　　　　　　}
	　　　　　　　　	}
				}
			}
...
//行业类别分析end
// 取水用途分析start
function pieChart(id,objs,unit){
	var piechart = Highcharts.chart(id, {
		...
		plotOptions: {
			...
			　　　　　　　return '<span style="color:#40c87e">' + this.y + unit;
			　　　　　　　}else if(this.point.name == '城镇公共用水'){
			　　　　　　　　　return '<span style="color:#c8905f">'+ this.y + unit ;
			　　　　　　　}else if(this.point.name == '城镇工业用水'){
			　　　　　　　　　return '<span style="color:#7bd8e9">'+ this.y + unit;
			　　　　　　　}else if(this.point.name == '生活（自备）'){
			　　　　　　　　　return '<span style="color:#fdb5c0">'+ this.y + unit;
			　　　　　　　}else if(this.point.name == '工业用水'){
			　　　　　　　　　return '<span style="color:#abd7e2">'+ this.y + unit;
			　　　　　　　}else if(this.point.name == '农业用水'){
			　　　　　　　　　return '<span style="color:#03fdfc">'+ this.y + unit;
			　　　　　　　}else if(this.point.name == '发电用水'){
			　　　　　　　　　return '<span style="color:#41e0ce">'+ this.y + unit;
			　　　　　　　}else if(this.point.name == '其他用水'){
			　　　　　　　　　return '<span style="color:#016600">'+ this.y + unit;
			　　　　　　　}
	　　　　　　　　	}
				}
			}
	...
	mui.ajax(_url, {
		...
		success: function(data) {
			...
			if(data.code == 1){
				...
				pieChart('pieChart1',data.data.use_type_statis,data.data.use_type_statis_unit);
			}
